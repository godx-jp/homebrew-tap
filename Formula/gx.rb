class Gx < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/godx-jp/godx-umbrella/releases/download/gx-v0.6.0/gx_v0.6.0_darwin_arm64.tar.gz"
      sha256 "c6257af627f5f83a532873e1e0df8f7ba63c27919ec190d1ac8c9422c340fe70"
    end
    on_intel do
      url "https://github.com/godx-jp/godx-umbrella/releases/download/gx-v0.6.0/gx_v0.6.0_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/godx-jp/godx-umbrella/releases/download/gx-v0.6.0/gx_v0.6.0_linux_arm64.tar.gz"
      sha256 "b7f9ae8da0ef27c512a02fa219ba80fc8ce86b545fae9c37c17238001fb66e80"
    end
    on_intel do
      url "https://github.com/godx-jp/godx-umbrella/releases/download/gx-v0.6.0/gx_v0.6.0_linux_amd64.tar.gz"
