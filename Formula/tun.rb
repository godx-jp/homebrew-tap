class Tun < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "277cf894cff82dec7c2ae9ef07b6b41264012c05dea1ab9494eefff6dc416358"
    end
    on_intel do
      url "https://github.com/godx-jp/homebrew-tap/releases/download/v#{version}/tun_#{version}_darwin_amd64.tar.gz"
      sha256 "a58437f5e5e4c90a48f8189438063ea70c57cba128cff3b2229da7e918b86501"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "e72b962c37014c2526a8043a93b0fd002b6e32ca6e1335e7358603fbd8de8c34"
    end
    on_intel do
      url "https://github.com/godx-jp/homebrew-tap/releases/download/v#{version}/tun_#{version}_linux_amd64.tar.gz"
      sha256 "e26d49991a642090c2382f6089a2fc776952662b35d507c82c3f97f51d869155"
    end
  end
