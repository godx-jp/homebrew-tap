class Tun < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "ab334dd635f0944e3c6284cbc8b1bd0ec8971966bf6744ccc8203a60f8e47aff"
    end
    on_intel do
      url "https://github.com/godx-jp/homebrew-tap/releases/download/v#{version}/tun_#{version}_darwin_amd64.tar.gz"
      sha256 "2f5cbd0c945bd8a9728646a4a8142f159c8fe14a4452c087dcd067163cef168a"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "c4f091f907f009bfdba5a3365a7c2ed871054651b69ad11738e1f5debd38c7c8"
    end
    on_intel do
      url "https://github.com/godx-jp/homebrew-tap/releases/download/v#{version}/tun_#{version}_linux_amd64.tar.gz"
      sha256 "e90d9bfba088fcc5c7f3f0e375db065860977c1f91bf8a84498473578ff558fe"
    end
  end
